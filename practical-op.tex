...
\begin{figure}[h]
 ...
 % 500LD-cartoon.pdf: 0x0 pixel, 0dpi, nanxnan cm, bb=
 \caption{Photo of 500LD: A) LHe inlet port, B) LHe outlet port, C) pressurization port, D) vacuum pump out port.}
 \label{fig:500LD-cartoon}
 \end{minipage}
 \end{figure}
...
\centering
 ...
 % 500LD-cartoon.pdf: 0x0 pixel, 0dpi, nanxnan cm, bb=
 \caption{An example of 250LD ports: A) LHe inlet port, B) pressure relief valve, C) pressurization port.}
